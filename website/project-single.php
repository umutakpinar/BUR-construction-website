...
<head>
    <meta charset="utf-8">
    <title>Proje İsmi Editlemeyi Unutma</title> <!-- Bu kısımda sayfa başlığı girilecek -->
...
<body class="body-inner">
    ...
    <!-- Proje banner kısmı editlemeyi unutma her projenin ismini db'den çekmek mantıklı olabilir -->
