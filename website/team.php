...
<head>
    <meta charset="utf-8">
    <title>Team</title> <!-- Bu kısımda sayfa başlığı girilecek -->
...
<body class="body-inner">
    ...
    <!-- 
    Bu kısım da veritabanından çekilecek şekilde düzenlenmeli çalışanlar veritabanından gelmeli ki 
    yeni bir çalışan eklendiğinde otomatik olarak sitede de gözüksün -->
