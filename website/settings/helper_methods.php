<?php
//öncelikle ben bu sayfaya verileri gönderirken hem post hem get olarak gönderimiştim bu nedenle
// get olarak gönderdiğim değerin islem=get olup olmadığını kontrol etmem gerekli
...
// bu sayede bize get ile gönderilen islem değişkeni giris ise giriş işlemini gerçekleştirecek
//  yok renk modu gibi bir değeri var ise renk modunu değiştirecek 

//aynı işlemi post için de yaptım
...
//Ayrıca bir de session değerini alabilmek adına; yani set edildiyse session değerini edilmediyse false döndüren bir fonksiyon yazalım
